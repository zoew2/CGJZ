...
# run lead
#time python3 run_summarization.py "$dir"/GuidedSumm11_test_topics.xmll lead --output_dir ../outputs/D4_eval/
# evaluate lead
...
# evaluate melda
#"$ROUGE_DIR"/ROUGE-1.5.5.pl -e "$ROUGE_DIR"/data -a -n 2 -x -m -c 95 -r 1000 -f A -p 0.5 -t 0 -l 100 -s -d "$RESULTS_FILE_PATH"/melda_rouge_evalset.xml &> "$RESULTS_FILE_PATH"/melda_rouge_evalset_scores.out
